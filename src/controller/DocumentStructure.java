...
public class DocumentStructure {
    ...
    public boolean generateContent() {
        //STRUCTURE HEADER
        //==========================================================================================
        TAG rootTag = xmlc.toCreate("ClinicalDocument xmlns=\"urn:hl7-org:v3\" xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' classCode='DOCCLIN'","");
        ...
        h[3] = xmlc.toCreate("id root='"+getClinicalDocument().getHeader().getIdRoot()+"' extension='"+getClinicalDocument().getHeader().getExtension()+"'","");
        h[4] = xmlc.toCreate("code code='"+getClinicalDocument().getHeader().getCode()+"' displayName='"+getClinicalDocument().getHeader().getDisplayName()+"' codeSystem='"+getClinicalDocument().getHeader().getCodeSystem()+"' codeSystemName='"+getClinicalDocument().getHeader().getCodeSystemName()+"'","");
        h[5] = xmlc.toCreate("effectiveTime value=\""+getClinicalDocument().getHeader().getEfetiveTime()+"\"","");
        h[6] = xmlc.toCreate("confidentialityCode code=\"N\" displayName='Normal' codeSystem='2.16.840.1.113883.5.25' codeSystemName='Confidentiality'","");
        h[7] = xmlc.toCreate("setId extension=\""+getClinicalDocument().getHeader().getId()+"\" root=\""+getClinicalDocument().getHeader().getExtension()+"\"","");
        ...
        TAG P0 = xmlc.toCreate("id extension=\""+getClinicalDocument().getPatient().getId()+"\" root=\""+getClinicalDocument().getHeader().getExtension()+"\"","");
        ...
        TAG P5 = xmlc.toCreate("administrativeGenderCode code=\""+getClinicalDocument().getPatient().getGender()+"\" codeSystem=\""+getClinicalDocument().getPatient().getCodeSystem()+"\"",""); 
        ...
        TAG P8 = xmlc.toCreate("religiousAffiliationCode code='"+getClinicalDocument().getPatient().getReligious()+"'","");
        ...
        TAG P16 =xmlc.toCreate("id extension=\""+getClinicalDocument().getPatient().getIdExtension()+"\" root=\""+getClinicalDocument().getHeader().getExtension()+"\"","");
        //STRUCTURE AUTHOR
        //==========================================================================================
        ...
        TAG A3 = xmlc.toCreate("id root='"+getClinicalDocument().getHeader().getExtension()+"' extension='"+getClinicalDocument().getAuthor().getCrm()+"'", "");
        ...
        TAG CS3 = xmlc.toCreate("id extension=\""+getClinicalDocument().getPatient().getId()+"\" root=\""+getClinicalDocument().getHeader().getExtension()+"\"", "");
        ...
        TAG L4 = xmlc.toCreate("id extension=\""+getClinicalDocument().getPatient().getIdExtension()+"\" root=\""+getClinicalDocument().getHeader().getExtension()+"\"","");
        ...
        TAG R2 = xmlc.toCreate("id extension=\""+getClinicalDocument().getRelated().getId()+"\" root=\""+getClinicalDocument().getHeader().getExtension()+"\"", "");
        TAG R3 = xmlc.toCreate("setId extension=\""+getClinicalDocument().getRelated().getExtension()+"\" root=\""+getClinicalDocument().getHeader().getExtension()+"\"", "");
        ...
        TAG OFF11 =xmlc.toCreate("streetAddressLine", ""+getClinicalDocument().getResponsibleParty().getStreet()+"");
        TAG OFF12 =xmlc.toCreate("telecom value=\"tel:"+getClinicalDocument().getResponsibleParty().getPhone()+"\" use=\""+getClinicalDocument().getResponsibleParty().getUse()+"\"", "");
...
//        TAG OFF17 =xmlc.toCreate("given", ""+getClinicalDocument().getResponsibleParty().getName()+"");
        ...
        TAG OFF28 =xmlc.toCreate("streetAddressLine",""+getClinicalDocument().getResponsibleParty().getStreet()+"");
...
//        xmlc.toInsert(OFF14,OFF17);
        ...
        if(x!=0){
            ...
            for(int i = 0; i < x; i++){
                ...
                toCreateItems(getClinicalDocument().getComponents().get(i).getTitle(),getClinicalDocument().getComponents().get(i).getContent()));
            }
            for(int i = x-1; i >=0; i--){
